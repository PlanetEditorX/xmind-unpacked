/*! For license information please see preferences.js.LICENSE.txt */
  ...
  [7544],
  {
    26601: (e, t, n) => {
      ...
      function d(e) {
        var t,
          n,
          r = e.sizes.shift(),
          o = Math.max(Math.ceil(r[0]), 1),
          a = Math.max(Math.ceil(r[1]), 1),
          i = [o - 1, a - 1, 1, 1],
          s = Date.now(),
          l =
        ...
        l
          ? ((t = new OffscreenCanvas(1, 1)), (n = new OffscreenCanvas(o, a)))
        ...
        var c = t.getContext("2d"),
          u = n.getContext("2d");
        u &&
          (u.fillRect.apply(u, i),
          c.drawImage(n, o - 1, a - 1, 1, 1, 0, 0, 1, 1));
        var p = c && 0 !== c.getImageData(0, 0, 1, 1).data[3],
          m = Date.now() - s;
        return (
          ...
          l
            ? (postMessage({
              ...
              !p && e.sizes.length && d(e))
            : p
            ? e.onSuccess(o, a, m)
            : (e.onError(o, a, m), e.sizes.length && d(e)),
          p
        );
      }
      n.d(t, { Z: () => w });
      var p = [16384, 14188, 11402, 11180, 10836, 8192, 4096, 1],
        m = [8388607, 65535, 32767, 16384, 8192, 4096, 1],
        h = [4194303, 65535, 32767, 16384, 8192, 4096, 1],
        f = ["onError", "onSuccess"],
        v = {
          max: null,
          min: 1,
      ...
      function y(e) {
        ...
        if (e.useWorker && n) {
          var p = "\n            var canvasTest = ".concat(
            ...
            m = new Blob([p], { type: "application/javascript" }),
          ...
          (u = new Worker(h)),
            ...
            (u.onmessage = function (e) {
              var t = e.data,
                ...
                a = t.benchmark;
              t.isTestPass
                ? (g[r].onSuccess(n, o, a), delete g[r])
                : g[r].onError(n, o, a);
            });
        }
        return e.usePromise
              ...
              var i = o(
                ...
                {},
                {
                  onError: function (t, r, o) {
                    var i;
                    if (0 === e.sizes.length) i = !0;
                    else {
                      var l = s(e.sizes.slice(-1), 1),
                        c = s(l[0], 2),
                        u = c[0],
                        d = c[1];
                      i = t === u && r === d;
                    }
                    a(t, r, o), i && n({ width: t, height: r, benchmark: o });
                  },
                  onSuccess: function (e, n, r) {
                    l(e, n, r), t({ width: e, height: n, benchmark: r });
                  },
                }
              );
              if (u) {
                var p = i.onError,
                  m = i.onSuccess;
                (g[r] = { onError: p, onSuccess: m }), u.postMessage(c);
              } else d(i);
            })
          : u
          ? ((g[r] = { onError: a, onSuccess: l }), void u.postMessage(c))
          : d(e);
      }
      var w = {
        maxArea: function () {
        ...
        test: function () {
          ...
          return (
            (t.sizes = l(t.sizes)),
            t.width && t.height && (t.sizes = [[t.width, t.height]]),
            y(t)
          );
        },
      };
    ...
    41809: (e, t) => {
      ...
      function n(e) {
        ...
        for (var n = 0; n < e.length; n++) t = r[255 & (t ^ e[n])] ^ (t >>> 8);
        return -1 ^ t;
      }
      (t.E4 = function (e, t) {
        var n = e.slice(0, 33);
        ...
        (t.Hv = function (e, t) {
          ...
          if (-1 !== r.indexOf(o)) {
            ...
            h >= 0 ? ((d = 4 * Math.ceil((h + 28) / 3)), (p = !0)) : (d = 44);
          }
          -1 !== r.indexOf(a) && ((u = a), (d = 24));
          for (
      ...
      function m(e, t, r, i) {
        ...
        if (r === o) {
          ...
          if (
            ...
            return e.set(s, h), e.set(m, h + 13), e;
          }
          var f = new Uint8Array(4);
          (f[0] = 0), (f[1] = 0), (f[2] = 0), (f[3] = 9);
          var v = new Uint8Array(54);
          return v.set(e, 0), v.set(f, 33), v.set(s, 37), v.set(m, 50), v;
        }
      }
    },
    98056: (e, t, n) => {
    ...
    85990: (e, t, n) => {
      ...
      (A[I] =
        ...
        (e.exports = function e(t, n, W, O, E, C) {
          var P,
            M = 1 & n,
            j = 2 & n,
            L = 4 & n;
          if ((W && (P = E ? W(t, O, E, C) : W(t)), void 0 !== P)) return P;
          if (!x(t)) return t;
          var N = b(t);
          if (N) {
            if (((P = f(t)), !M)) return c(t, P);
          } else {
            var F = h(t),
              B = F == Z || "[object GeneratorFunction]" == F;
            if (y(t)) return l(t, M);
            if (F == T || F == I || (B && !E)) {
              if (((P = j || B ? {} : g(t)), !M))
                return j ? d(t, s(P, t)) : u(t, i(P, t));
            } else {
              if (!A[F]) return E ? t : {};
              P = v(t, F, M);
            }
            ...
            S(t)
              ...
              : w(t) &&
                t.forEach(function (r, o) {
                  P.set(o, e(r, n, W, o, t, C));
                });
          var $ = N ? void 0 : (L ? (j ? m : p) : j ? _ : k)(t);
          return (
            o($ || t, function (r, o) {
              $ && (r = t[(o = r)]), a(P, o, e(r, n, W, o, t, C));
            }),
            P
          );
        });
    ...
    23279: (e, t, n) => {
      ...
      e.exports = function (e, t, n) {
        ...
        function y(e) {
          var n = e - m;
          return void 0 === m || n >= t || n < 0 || (v && e - h >= u);
        }
        function w() {
          var e = o();
          if (y(e)) return x(e);
        ...
        function S() {
          ...
          if (((l = arguments), (c = this), (m = e), n)) {
            if (void 0 === p)
              return (function (e) {
                return (h = e), (p = setTimeout(w, t)), f ? b(e) : d;
              })(m);
            if (v) return clearTimeout(p), (p = setTimeout(w, t)), b(m);
          }
        ...
        return (
          ...
          r(n) &&
            ((f = !!n.leading),
            (u = (v = "maxWait" in n) ? i(a(n.maxWait) || 0, t) : u),
            (g = "trailing" in n ? !!n.trailing : g)),
          (S.cancel = function () {
            void 0 !== p && clearTimeout(p), (h = 0), (l = m = c = p = void 0);
          }),
          (S.flush = function () {
      ...
      const l = {
        ...
        methods: {
          updateTouchBarItems(e) {
            const t = (e) => {
              const t = e.click;
              let n = this._touchBarRoutes[t];
              return (
                n ||
                  ((n = {
                    method: t,
                    endpoint: (0, o.A6)(window.id, (0, a.rs)(t)),
                  }),
                  (this._touchBarRoutes[t] = n)),
                n.unroute || (n.unroute = s.ZP.route(n.endpoint, this[t])),
                Object.assign({}, e, { click: n.endpoint })
              );
            };
    ...
    49170: (e, t, n) => {
      ...
      var f = n(96829);
      const v = [
        { value: "default", text: (0, f.$T)("Default") },
        {
          value: "last",
          text: (0, f.$T)("The last skeleton & color theme used"),
        },
      ];
      var g = n(51189);
      const b = [
          {
            value: g.Mn.AUTO,
            text: (0, f.$T)("Download and install updates automatically"),
          },
          {
            value: g.Mn.MANUAL,
            text: (0, f.$T)(
          ...
          { value: g.Mn.NOT, text: (0, f.$T)("Disable automatic updates") },
        ],
        y = [
          { value: "auto", text: (0, f.$T)("System Default") },
          { value: "default", text: (0, f.$T)("Light") },
          { value: "dark", text: (0, f.$T)("Dark") },
        ];
      const w = (0, o.aZ)({
        __name: "field-selector",
        props: {
          title: { default: "" },
          label: null,
          items: null,
        ...
        setup(e, { emit: t }) {
          const n = e,
            r = (0, o.Fl)(
              () => n.items.find(({ value: e }) => e === n.value) || {}
            );
          return {
            __sfc: !0,
            props: n,
      ...
      const S = (0, x.Z)(
              ...
              t("div", { staticClass: "uk-form-controls" }, [
                t(
                  "button",
                  {
                    ...
                    staticStyle: { "max-width": "315px", width: "100%" },
                    attrs: { title: e.title },
                  },
                  [
                    t("span", { staticClass: "uk-text-truncate" }, [
                      e._v(e._s(n.selectedItem.text)),
                    ]),
                    e._v(" "),
                    t("span", {
                            ...
                            return t(
                              ...
                              [
                                t(
                                  "button",
                                  {
                                    class: { "uk-active": e.value === r.value },
                                    on: {
                                      click: function (e) {
                                        return n.handleSelectItem(r.value);
                                      },
                                    },
                                  },
                                  [
        ...
        k = (0, o.aZ)({
          name: "Appearance",
          components: { FieldSelector: S },
          setup(e, t) {
            const n = (e, ...t) => (0, c.JE)().T(e, ...t),
              r = (0, o.Fl)(() => (0, c.S)().systemAppearance),
              a = (0, o.Fl)(() => {
                const e = y.map((e) => ({ ...e, text: n("$$", e.text) }));
                return r.value ? e : e.slice(1);
              }),
              i = (0, o.Fl)(() => (0, c.S)().preferredAppearance),
              s = (0, o.Fl)(() => (0, c.S)().appearance),
              l = (0, o.iH)(""),
              u = (0, o.Fl)(() => (r.value ? i.value || "auto" : s.value));
            (0, o.bv)(() => {
              l.value = u.value;
            });
            return {
        ...
        setup(e, t) {
          ...
          return {
            ...
            handleLanguageChange: (e) => {
              (n.value = e), t.emit("select", { preferredLanguage: e });
            },
          };
        },
      });
      ...
      const T = (0, o.aZ)({
        ...
        setup(e, t) {
          const n = (e, ...t) => (0, c.JE)().T(e, ...t),
            r = (0, o.iH)(""),
            a = (0, o.Fl)(() => (0, c.S)().initialZoomLevel),
            i = (0, o.Fl)(() =>
              h.map((e) => ({ ...e, text: n("$$", e.text) }))
            );
          (0, o.bv)(() => {
            r.value = a.value;
          });
          return {
            ...
            selectedMapZoomValue: r,
            handleZoomLevelChange: (e) => {
              (r.value = e), t.emit("select", { preferredInitialZoomLevel: e });
            },
          };
        },
      });
      ...
      const O = (0, o.aZ)({
        ...
        setup(e, t) {
          const n = (e, ...t) => (0, c.JE)().T(e, ...t),
            r = (0, o.iH)(""),
            a = (0, o.Fl)(() => (0, c.S)().defaultTheme),
            i = (0, o.Fl)(() =>
              v.map((e) => ({ ...e, text: n("$$", e.text) }))
            );
          (0, o.bv)(() => {
            r.value = a.value;
          }),
          ...
          return {
            ...
            selectedDefaultTheme: r,
            handleDefaultThemeChange: (e) => {
              (r.value = e), t.emit("select", { defaultTheme: e });
            },
          };
        },
      });
      ...
      const P = (0, o.aZ)({
        ...
        setup(e, { emit: t }) {
          const n = (0, c.JE)().T,
            { getLoadedFonts: r } = (0, C.r)(),
            a = (0, o.iH)(""),
            i = (0, o.iH)([]),
            s = (0, o.Fl)(() => (0, c.S)().cjkFontFamily);
          (0, o.bv)(async () => {
            const { systemFonts: e } = await r(),
              t = { value: "", text: n("Default") };
            (i.value = [].concat([
              t,
          ...
          return t(
            n.FieldSelector,
            {
              attrs: {
                ...
                items: n.cjkFontFamilyOptions,
                value: n.selectedCJKFontFamilyValue,
                "list-style": "uk-height-max-medium",
              },
              on: { select: n.handleCJKFontFamilyChange },
            },
            [
              0 === n.cjkFontFamilyOptions.length
                ? t(
                    "div",
                    {
                      staticClass:
      ...
      const j = (0, o.aZ)({
        ...
        setup(e, t) {
          const n = (e, ...t) => (0, c.JE)().T(e, ...t),
            r = (0, o.iH)(""),
            a = (0, o.Fl)(() => (0, c.S)().getAutoUpdateType),
            i = (0, o.Fl)(() =>
              b.map((e) => ({ ...e, text: n("$$", e.text) }))
            );
          (0, o.bv)(() => {
            r.value = a.value;
          });
      ...
      const F = (0, x.Z)(
                ...
                t(
                  ...
                  [
                    t(
                      "label",
                      {
                        staticClass: "uk-flex uk-flex-row",
        ...
        B = (0, o.aZ)({
          name: "QuickEntry",
          components: { FieldCheckbox: F },
          setup(e, t) {
            const n = (0, o.iH)(null),
              r = (0, o.Fl)(() => (0, c.S)().autoLaunchQuickEntry);
            (0, o.bv)(() => {
              n.value = r.value;
            });
            return {
              quickEntryAutoLaunchValue: n,
      ...
      const z = (0, o.aZ)({
        ...
        setup(e, t) {
          const n = (0, o.iH)(null),
            r = (0, o.Fl)(() => !s.nd && (0, c.S)().sendUsageData);
          (0, o.bv)(() => {
            n.value = r.value;
          });
          return {
            sendUsageDataValue: n,
      ...
      const U = (0, o.aZ)({
        name: "ShareService",
        setup(e, t) {
          const n = (0, o.FN)().proxy,
            r = (e, ...t) => (0, c.JE)().T(e, ...t),
            a = (0, o.Fl)(() => (0, c.qr)().serviceRegion),
            i = (0, o.Fl)(() => (0, c.qr)().blockedShareItems),
            l = (0, o.Fl)(() =>
              [
                {
                  id: "xmind share",
                  title: r("Submit to Gallery"),
                  description: r(
                    "Upload the map to Xmind.app and generate a link."
                  ),
                  iconURL: n.$toResourceURL(
                ...
                },
                {
                  id: "blog",
                  title: r("Blog"),
                  description: r("Generate an embed code for your blog."),
                  iconURL: n.$toResourceURL("static/images/share-blog.svg"),
                },
                {
                  id: "email",
                  title: r("Email"),
                  description: r("Share the map via Email."),
                  iconURL: n.$toResourceURL("static/images/share-email.svg"),
                  canHidden: "cn" !== a.value,
                  hidden: !1,
                },
                {
                  id: "evernote",
                  title: "Evernote",
                  description: r("Save the map to Evernote notebooks."),
                  iconURL: n.$toResourceURL("static/images/share-evernote.svg"),
                  canHidden: !0,
                  hidden: !1,
                },
                {
                  ...
                  iconURL: n.$toResourceURL("static/images/share-facebook.svg"),
                  canHidden: !0,
                  hidden: !1,
                },
                {
                  id: "twitter",
                  title: "X",
                  description: r("Generate a link and share via your X."),
                  iconURL: n.$toResourceURL("static/images/share-twitter.svg"),
                  canHidden: !0,
                  hidden: !1,
                },
                {
            ...
            m = (0, o.Fl)(() => !!(0, c.vF)().accessToken),
            h = (0, o.iH)([]),
            f = (0, o.Fl)(() => (0, c.S)().preferredHiddenShareItems);
          return (
            (0, o.YP)(
              () => p.value,
              (e) => {
                e ||
                  (0, c.S)().updatePreferences({
                    preferredHiddenShareItems: f.value.concat("evernote"),
                  });
              },
              { immediate: !0 }
            ),
            ...
            ),
            {
              ...
              toggleHiddenShare: (e) => {
                h.value.includes(e)
                  ...
                  : h.value.push(e),
                  t.emit("toggle", { preferredHiddenShareItems: h.value });
              },
              withMasDemoCheck: (e) => {
      ...
      const H = (0, x.Z)(
        ...
        function () {
          ...
          return t("div", [
            ...
            e._v(" "),
            t("fieldset", { staticClass: "uk-margin-small-top uk-fieldset" }, [
              t(
                "div",
                { staticClass: "uk-panel uk-flex" },
                [
                  e._l(e.shareServiceItems, function (n, r) {
                    return [
                      t("a", {
                        key: n.id,
                        staticClass: "uk-background-contain",
                        class: [0 === r ? "" : "uk-margin-left"],
                        staticStyle: { width: "24px", height: "24px" },
                        style: {
                          opacity: e.hiddenShareItems.includes(n.id) ? 0.2 : 1,
                        },
                        attrs: {
                          draggable: "false",
                          "data-src": n.iconURL,
                      ...
                      t(
                        ...
                        [
                          t("h4", [e._v(e._s(n.title))]),
                          e._v(" "),
                          t("p", [e._v(e._s(n.description))]),
                          e._v(" "),
                          "evernote" === n.id && e.evernoteAuthName
                            ? [
                            ...
                            : e._e(),
                          e._v(" "),
                          "biggerplate" === n.id && e.biggerplateAuthorized
                            ? [
                                t("p", [
                                  t(
                                    "button",
                                ...
                                t("p", [
                                  t(
                                    "button",
                                    {
                                      ...
                                      on: {
                                        click: function (t) {
                                          return e.toggleHiddenShare(n.id);
                                        },
                                      },
                                    },
                                    [
                                      e._v(
                                        "\n                " +
                                          e._s(
                                            e.hiddenShareItems.includes(n.id)
                                              ? e.$T("Show in The Share Menu")
                                              : e.$T("Hide in The Share Menu")
                                          ) +
                                          "\n              "
                                      ),
                                    ]
      ...
      const V = (0, o.aZ)({
        ...
        setup(e, { emit: t }) {
          const n = (0, o.Fl)(
            () => (0, c.S)().shouldShowGuidelineForMovingTopics
          );
          return {
            __sfc: !0,
            emits: t,
            shouldShowGuidelineForMovingTopics: n,
            handleCheck: (e) => {
              t("select", {
                shouldShowGuidelineForMovingTopics: e.target.checked,
              });
            },
            FieldCheckbox: F,
          };
      ...
      const q = (0, x.Z)(
          ...
          function () {
            var e = this,
              t = e._self._c,
              n = e._self._setupProxy;
            return t(n.FieldCheckbox, {
              attrs: {
                name: "spellCheck",
                label: e.$T("Smart Guideline:"),
                value: n.shouldShowGuidelineForMovingTopics,
                desc: e.$T("Always Display"),
              },
              on: { check: n.handleCheck },
            });
          },
          [],
          !1,
        ...
        J = (0, o.aZ)({
          ...
          components: {
            ...
            ShareService: H,
            GuideLine: q,
            ShortcutsPanel: () => Promise.resolve().then(n.bind(n, 30507)),
          },
          mixins: [l.Z],
          setup() {
            const e = (e, ...t) => (0, c.JE)().T(e, ...t),
              ...
              a = (0, o.iH)(!1),
              l = (0, o.iH)("general"),
              p = (0, o.Fl)(() => ["general", "shortcuts"].indexOf(l.value)),
              m = (0, o.Fl)(() => [
            ...
            return {
              ...
              activeTabIndex: p,
              tabs: m,
              isTabDividerVisible: a,
              handlePreferencesChange: (e) => {
                h.value = { ...h.value, ...e };
              },
              applyChanges: () => {
                n.value && n.value.applyChanges(),
                  d.ZP.fetch(u.Pp, {
                    mutations: [
                      {
                        id: "preferences",
              ...
              restoreShortcuts: () => {
                n.value && n.value.resetToDefault();
              },
              handleTabDividerVisibleChange: ({ visible: e, direction: t }) => {
                a.value = !1 === e && "bottom" === t;
              },
            };
          },
        });
        ...
        function () {
          ...
          return t(
            ...
            [
              t(
                "div",
                { staticClass: "vk-window-title-bar" },
                [
                  t("div", { staticClass: "vk-window-title" }, [
              ...
              t(
                ...
                {
                  ref: "content",
                  staticClass: "vk-window-body uk-flex uk-flex-column",
                ...
                [
                  t(
                    ...
                    {
                      staticClass:
                        "uk-tab uk-tab-large uk-flex-center vk-tab-capsule uk-margin-remove",
                      staticStyle: {
                        "padding-top": "16px",
                        "padding-bottom": "4px",
                      },
                  ...
                  t(
                    "div",
                    {
                      staticClass: "uk-height-expand uk-flex uk-flex-column",
                      class: {
                    ...
                    [
                      t("visibility-sensor", {
                        on: { change: e.handleTabDividerVisibleChange },
                      }),
                      e._v(" "),
                      t(
                        "ul",
                        {
                          ...
                          staticClass: "uk-switcher uk-height-1-1",
                        ...
                        [
                              ...
                              t(
                                ...
                                [
                                  ...
                                  e.isLicenseMode
                                    ...
                                    : t("share-service", {
                                        on: {
                                          toggle: e.handlePreferencesChange,
                                        },
                                      }),
                                  e._v(" "),
                                  e.isLicenseMode
                          ...
                          t(
                            ...
                            {
                              staticClass:
                                "uk-panel uk-padding-large uk-flex uk-flex-column uk-position-relative uk-height-1-1",
                            },
              ...
              t(
                "div",
                { staticClass: "vk-window-button-bar uk-workbench-bottom" },
                [
                  t("div", { staticClass: "vk-button-group" }, [
                    t(
                      "button",
                      {
    ...
    59042: (e, t, n) => {
          ...
          e.directive(t, {
            ...
            update: function (e, n, r, o) {
              if (o.data && o.data.directives) {
                var a = o.data.directives.find(function (e) {
                  return e.name === t;
                });
                if (a && a.value !== n.value)
                  return (
                    a && a.value(null, o.key),
                    void n.value(r.componentInstance || e, r.key)
                  );
              }
      ...
      const K = {
        ...
        X = (() => {
          ...
          return {
            ...
            plugin: (n) => {
              (0, A.W$)(n.store.$id) &&
                n.store.$subscribe((r, o) => {
                  if (n.store.$id !== r.storeId) return;
                  const i = t.get(r.storeId);
                  t.set(r.storeId, !0),
                    (null === window || void 0 === window
                      ? void 0
                      : window.isEditorFrame) ||
                      (i &&
                        r.type !== Z.x1.patchObject &&
                        (0, A.W$)(r.storeId) &&
                        (e.push({
                          id: r.storeId,
        ...
        Y = {
          start: () => {
            (0, B.r)();
            const e = (0, P.ju)("/static/snowbird/resource/"),
              t = (function () {
                const e = {};
                return (
                  N.Fy((t, n) => {
              ...
              n = Object.values(t)
                ...
                .map((t) =>
                  (function (
                    ...
                    let s = { family: e, source: `url("${i}")`, url: i };
                    return (
                      void 0 !== n &&
                        (s = { ...s, style: n ? "italic" : "normal" }),
                      void 0 !== r && (s = { ...s, weight: r.toString() }),
                      void 0 !== o && (s = { ...s, unicodeRange: o }),
                      s
                    );
                  })(t, e)
                );
            !(function (e) {
              ...
              (function () {
                ...
                (e.innerHTML = t),
                  ...
                  document.body.style.setProperty("--info-button-font", N.o6);
              })(),
              (0, F.O)().updateBuiltinFontFamilies(
        ...
        Q = {
          start: () => {
            ...
            t &&
              (e.startJob(),
              G.debug("About to load CSS using _apr query parameter:", t),
              (0, z.Z)(t, () => {
                G.debug("Loaded CSS using _apr query parameter:", t),
                  setTimeout(() => {
                    e.endJob();
                  }, 10);
              })),
            ...
            const r = (0, u.YP)(
              ...
              (e) => {
                e &&
                  ...
                  (0, u.YP)(
                    () => (0, A.qr)().systemAccentColor,
                    (e) => U(e)
                  ),
                  (0, u.YP)(
                    () => (0, A.S)().systemScrollbarSetting,
                    (e) =>
                      (function (e) {
        ...
        ee = {
          start: () => {
            H.nd &&
              H.qu.forEach((e) => {
                (0, A.JX)().appendBeforeHandler(e, () =>
                  (async () => (await a.ZP.fetch(w.QN), "interruption"))()
                );
              }),
              Object.keys(H.JN)
                .concat(Object.keys(H.oF))
                .forEach((e) => {
                  (0, A.JX)().appendBeforeHandler(e, () => {
                    const t = (0, A.JX)().commandById(e);
              ...
              (0, A.JX)().appendAfterHandler("editor.addTodo", J.l5),
              (0, A.JX)().appendAfterHandler("editor.cancelTask", J.DY),
              (0, A.JX)().appendAfterHandler("editor.checkTodo", () => {
                (0, J.fR)("checkTask");
              }),
              (0, A.JX)().appendAfterHandler("editor.uncheckTodo", () => {
                (0, J.fR)("uncheckTask");
              }),
              H.QL.forEach((e) => {
                (0, A.JX)().appendBeforeHandler(e, () => {
                  if ((0, A.si)().contexts["collaboration.isReadOnly"])
                    return "interruption";
                });
              }),
              H.gY.forEach((e) => {
                (0, A.JX)().appendBeforeHandler(e, () => {
                  if ((0, A.si)().contexts["collaboration.isFromCloud"])
                    return "interruption";
                });
              });
          },
        ...
        te = {
          start: () => {
            const e = (0, L.i)();
            e.startJob(),
              (0, A.JX)().injectDoHandleCommand(async (e, t) =>
        ...
        ne = [X.plugin];
      var re = n(7710);
      const oe = p().parse(window.location.search.slice(1)),
        ae = !0,
        ie = !!oe.isBrowserView,
        se = !!oe.isEditorFrame;
      let le = h.getCurrentWindow;
      ie &&
        (le = function () {
          const e = S.Z.sendSync("get-current-window-id");
          return h.BrowserWindow.fromId(parseInt(e));
        });
      const ce =
          window.location.pathname.match(/\/([a-zA-Z0-9-]+)\.html$/)[1] ||
          "default",
        ue = (0, o.ZP)("performance"),
        de = (0, o.ZP)("sentry");
      ue.debug("Initializing page:", ce),
        m.webFrame.setVisualZoomLevelLimits(1, 1),
        document.body.classList.add("uk-win32"),
        Object.defineProperty(window, "id", { get: () => le().id }),
      ...
      (window.getCurrentWindowAsync = async () => {
        ...
        (window.isEditorFrame = se);
      const pe = u.ZP.observable({
        isBeingDestroyed: !1,
        isDestroyed: !1,
        isShown: !1,
      });
      ["isBeingDestroyed", "isDestroyed", "isShown"].forEach((e) => {
        ...
        (window.isMinimized = () => le().isMinimized()),
        (window.isMaximized = () => le().isMaximized()),
        (window.isFullScreen = () => le().isFullScreen()),
        (window.resizeTo = (e, t) => {
          le().setContentSize(e, t);
        }),
        (window.resizeBy = (e, t) => {
          let [n, r] = le().getContentSize();
          le().setContentSize(n + e, r + t);
        }),
        (window.moveTo = (e, t) => {
          le().setPosition(e, t);
        }),
        (window.moveBy = (e, t) => {
          let [n, r] = le().getPosition();
          le().setPosition(n + e, r + t);
        }),
        x.Z.on("window-maximize", () => {
          document.body.classList.add("uk-window-maximized"),
            window.dispatchEvent(new Event("maximize"));
        }),
        x.Z.on("window-unmaximize", () => {
          document.body.classList.remove("uk-window-maximized"),
            window.dispatchEvent(new Event("restore"));
        }),
        x.Z.on("window-minimize", () => {
          window.dispatchEvent(new Event("minimize"));
        }),
        x.Z.on("window-unminimize", () => {
      ...
      if (
        ...
        document.addEventListener("dblclick", (t) => {
          const { target: n, defaultPrevented: r } = t;
          if (r) return;
          let o = n;
          for (; o && "function" == typeof o.matches; ) {
            if (e.some((e) => o.matches(e))) return;
            o = o.parentNode;
          }
          let a =
      ...
      u.ZP.use(Z.og),
        u.ZP.use(new C((e) => c.handle(e))),
        u.ZP.use(v()),
        u.ZP.use(W),
        u.ZP.use(M),
        u.ZP.use(T),
        u.ZP.use(g.ZP.Plugin),
        ue.debug("Initialized page:", ce);
      const he = (0, Z.WB)();
      (0, Z.uX)(he),
        ne.forEach((e) => he.use(e)),
        Object.values(A.rx).forEach((e) => e()),
        K.start(),
        X.start(),
        Y.start(),
        Q.start(),
        ee.start(),
        te.start();
      const fe = (0, _.Z)("version").includes("beta");
        ...
        const e = (0, u.YP)(
          ...
          (t) => {
            ...
            try {
              ...
              de.error("Failed to init sentry", e);
            }
          },
          { immediate: !1 }
        );
      ...
      async function ve(
        ...
        ue.debug("Bootstrapping:", ce);
        for (let e of r) u.ZP.use(e);
        let l;
        return (
          (0, A._t)((0, y.b3)(window.id)),
          "dialog-err" === n && (0, A.VE)((0, y.zN)("dialog-err", window.id)),
          "dialog-problem" === n &&
            (0, A.ym)((0, y.zN)("dialog-problem", window.id)),
          i && (0, A.OD)((0, y.aJ)(i)),
          await new Promise((n) => {
            let r = (0, u.YP)(
              () => (0, L.i)().ready,
              (i) => {
                i &&
                  (r(),
                  document.body.classList.add(`uk-lang-${(0, A.S)().language}`),
                  o?.(he),
                  ue.debug("About to create Vue instance:", ce),
                  (l = new u.ZP({ ...e, pinia: he })),
                  ue.debug("Created Vue instance:", ce),
                  window.addEventListener("unload", () => {
                    (window.isBeingDestroyed = !0),
                      l.$destroy(),
                      (window.isDestroyed = !0);
                  }),
                  ue.debug("About to mount Vue instance:", ce),
                  l.$mount(t || "#app"),
                  ue.debug("Mounted Vue instance:", ce),
                  (0, j.qJ)().then(async () => {
                    if (!s) return;
                    const e = await window.getWindowIdAsync();
    ...
    13382: (e, t, n) => {
      ...
      async function g(e) {
        (e = Object.assign({}, e || {})).icon &&
          ...
          (e.icon = o().join((0, i.bY)(), e.icon));
        const t = a.BrowserWindow.fromId(window.id),
          { response: n, checkboxChecked: r } = await a.dialog.showMessageBox(
            t,
            e
          );
        return [n, r];
      ...
      async function b(e) {
        ...
        return t
          ...
          : (n && r && (await l.Z.bindBookmark({ fp: n, bookmark: r })),
            n && (0, m.km)().setLastSaveDirectory(o().dirname(n)),
            n);
      }
      async function y({ folderName: e, dialogOptions: t }) {
        ...
        if (
          ((n = i[0]),
          i.length > 0 && s && (await l.Z.bindBookmark({ fp: n, bookmark: s })),
          "string" == typeof e)
        ) {
          let t = e.replace(/[\\/]/g, "");
          (t = (0, p.N6)(t).replace(/\.+$/g, "").trim()), (n = o().join(n, t));
        }
        return (
      ...
      async function S(e) {
        ...
        o === r.indexOf(n) && u.ZP.fetch(d.lf.GO_DOWNLOAD);
      }
      async function k(e) {
      ...
      async function _(e) {
        ...
        let [a] = await g({
          ...
          cancelId: o.indexOf(r),
          noLink: !0,
        });
        const i = a === o.indexOf(t),
          s = a === o.indexOf(n);
      ...
      async function I(e) {
        ...
        return { toFix: o === r.indexOf(t), toCancel: o === r.indexOf(n) };
      }
    },
    33394: (e, t, n) => {
      "use strict";
      ...
      const h = {
        read: async function (e) {
          ...
          try {
            return await (0, s.promisify)(o().readFile)(e);
          } catch (t) {
        ...
        write: async function (e, t) {
          ...
          try {
            return await (0, s.promisify)(o().writeFile)(e, t);
          } catch (n) {
        ...
        i = new Proxy(o(), {
          get(e, t) {
            ...
            return "function" == typeof n
              ? (...r) => {
                  if (!window.isDestroyed) return n.apply(e, r);
                  a.error(
      ...
      function a(e, t) {
        return new Promise((n) => {
          ...
          r.ipcRenderer.once(
            ...
            r.ipcRenderer.send(`internal-ipc-api:${e}`, { payload: t, seq: a });
        });
      }
    },
    28914: (e, t, n) => {
      ...
      n.d(t, { Z: () => a });
      var r = n(72298);
      const o = (0, n(23352).ZP)("ipc:proxy:"),
        a = new Proxy(r.ipcRenderer, {
          get(e, t) {
            let n = Reflect.get(e, t);
            return "function" == typeof n
              ? (...r) => {
      ...
      function s(e, t) {
        ...
        return n
          ...
          : new Promise((n, a) => {
              ...
              o.Z.once(
                `ipc-api-reply:${e}:${s}`,
                (e, { error: t = null, data: o = null }) => {
                  t ? a((0, r.aq)(t)) : n(o);
                }
              ),
                o.Z.send(`ipc-api:${e}`, { payload: t, seq: s });
            });
      }
      const l = {
        fetch: s,
        route: function (e, t) {
          ...
          const i = (n, { payload: a = null, seq: i = 0 } = {}) => {
            ...
            Promise.resolve()
              ...
              .catch((e) => {
                o.Z.send(s, { error: (0, r.SC)(e) });
              });
          };
          return (
            a.set(e, t),
            o.Z.on(n, i),
            o.Z.send("ipc-api-register", { apiName: e }),
            () => {
              o.Z.send("ipc-api-unregister", { apiName: e }),
                o.Z.removeListener(n, i),
                a.delete(e);
            }
          );
        },
    ...
    23352: (e, t, n) => {
      ...
      var r = n(82134),
        ...
        a = n(79409),
        i = n(72298);
      const s = new r.Jq(global.console, { colorful: !1 }),
        l = new r.Yd({
          isDebugging:
    ...
    79409: (e, t, n) => {
      ...
      function c(e = null) {
        return (
          l ||
            (l = JSON.parse(
              i().readFileSync(o().join((0, s.bY)(), "package.json"))
            )),
          e ? l[e] : l
        );
      }
    ...
    69931: (e, t, n) => {
      ...
      var r = n(71017),
        ...
        s = n(5893);
      function l(e) {
        return (0, s.u3)(o().join((0, i.bY)(), e));
      }
      function c(e) {
        return (0, s.u3)(o().join((0, i.D8)(), e));
      }
      function u(e) {
        return a.Z.readFile(o().join((0, i.bY)(), e));
      }
      const d = (...e) =>
        l(...e)
          .replace("(", "%28")
    ...
    73884: (e, t, n) => {
      ...
      const i = new (o())(),
        s = i.emit;
      (i.emit = function (e, ...t) {
        s.call(i, e, ...t), c(e) && a.Z.send("revents:broadcast", [e, ...t]);
      }),
        i.on("newListener", (e) => {
          if (c(e)) {
            0 === i.eventNames().filter(c).length &&
    ...
    69297: (e, t, n) => {
      ...
      var r = n(28914);
      function o() {
        return r.Z.sendSync("usage-stats:data");
      }
      function a() {
        r.Z.send("usage-stats:increase", {
          type: "dwellTimeInZenMode",
          value: 1e3,
        });
      }
      function i(e = 1) {
        r.Z.send("usage-stats:increase", { type: "topicsAdded", value: e });
      }
      function s(e = 1) {
        r.Z.send("usage-stats:increase", { type: "sheetsAdded", value: e });
      }
      function l(e = 1) {
        r.Z.send("usage-stats:increase", { type: "eventsTriggered", value: e });
      }
    },
    18621: (e, t, n) => {
      "use strict";
      ...
      var r = n(28914);
      function o(e) {
        r.Z.send("usage-tracker:track-event", { event: e });
      }
      function a(e) {
        r.Z.send("usage-tracker:track-view", { view: e });
      }
    },
    7104: (e, t, n) => {
      "use strict";
      ...
      let l = null;
      function c() {
        return l || (l = a.ipcRenderer.sendSync("workspace:appPath")), l;
      }
      function u() {
        return o().join(
          (s || (s = a.ipcRenderer.sendSync("workspace:userData")), s),
          "vana"
        );
      }
      function d() {
        return o().join(u(), "workbooks");
      }
      function p() {
        return o().join(u(), "file-cache");
      }
      function m() {
        return o().join(u(), "theme");
      }
      function h() {
        return o().join(u(), "smart-color");
      }
      function f() {
        return o().join(u(), "illustrations");
      }
      function v() {
        return o().join(u(), "templates");
      }
      function g() {
        return o().join(c(), "static/snowbird/resource/");
      }
      async function b() {
        return (
          s || (s = await (0, i.A)("workspace:userData")),
          o().join(s, "vana", "workbooks")
        );
      }
    },
    38629: (e, t, n) => {
      ...
      function o(e, t = null) {
        ...
        const n = (0, r.ju)("static/vanakit/themes/vana.css"),
          o = document.createElement("link");
        (o.type = "text/css"),
          (o.id = "appearance_link"),
          (o.rel = "stylesheet"),
          (o.href = n),
          o.setAttribute("data-appearance", e),
          "function" == typeof t && (o.onload = () => t()),
    ...
    60746: (e, t, n) => {
      ...
      const c = { cache: !1 },
        ...
        d = (e = {}) => {
          ...
          return function (e = "", o = "") {
            ...
            return t.cache && (r[e] = i.width), i.width;
          };
        };
      function p() {
      ...
      const b = ({ width: e, height: t, animate: n = !1 }) => {
          o.getCurrentWindow().setSize(e, t, n);
        },
        y = (e) => {
      ...
      const x = (e, t) =>
          0 === e ||
          0 === t ||
          s.Z.test({ width: e, height: t, sizes: [e, t] }),
        S = async (e, t, n = 1) => {
          if (x(e * n, t * n)) return n;
          const r = await s.Z.maxWidth({ usePromise: !0 }),
            o = await s.Z.maxHeight({ usePromise: !0 }),
            a = await s.Z.maxArea({ usePromise: !0 }),
            i = r.width,
            l = o.height,
            c = a.width * a.height;
          let u = n;
    ...
    66040: (e, t, n) => {
      "use strict";
      n.d(t, { ed: () => o, qr: () => a, ys: () => i });
      var r = n(96829);
      const o = [
          {
            commandId: "home",
            label: (0, r.WZ)("Open Home"),
            category: (0, r.WZ)("General"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "new",
            label: (0, r.WZ)("New Blank Map"),
            category: (0, r.WZ)("General"),
            isSupportedInOutliner: !0,
          },
          {
          ...
          null,
          {
            ...
            label: (0, r.WZ)("Merge All Windows"),
            category: (0, r.WZ)("General"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.addSheet",
            label: (0, r.WZ)("New Sheet"),
            category: (0, r.WZ)("General"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.newSheetFromTopic",
            label: (0, r.WZ)("New Sheet From Topic"),
            category: (0, r.WZ)("General"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.previousSheet",
            label: (0, r.WZ)("Previous Sheet"),
            category: (0, r.WZ)("General"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.nextSheet",
            label: (0, r.WZ)("Next Sheet"),
            category: (0, r.WZ)("General"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "frame.addNewTab",
            label: (0, r.WZ)("New Tab"),
            category: (0, r.WZ)("General"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "frame.previousTab",
            label: (0, r.WZ)("Previous Tab"),
            category: (0, r.WZ)("General"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "frame.nextTab",
            label: (0, r.WZ)("Next Tab"),
            category: (0, r.WZ)("General"),
            isSupportedInOutliner: !0,
          },
          {
          ...
          {
            commandId: "duplicate",
            label: (0, r.WZ)("Duplicate"),
            category: (0, r.WZ)("General"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.copyStyle",
            label: (0, r.WZ)("Copy Style"),
            category: (0, r.WZ)("General"),
          },
          {
            commandId: "editor.pasteStyle",
            label: (0, r.WZ)("Paste Style"),
            category: (0, r.WZ)("General"),
          },
          {
            commandId: "editor.resetStyle",
            label: (0, r.WZ)("Reset Style"),
            category: (0, r.WZ)("General"),
          },
          {
            commandId: "delete",
          ...
          },
          {
            ...
            label: (0, r.WZ)("Delete Single Topic"),
            category: (0, r.WZ)("General"),
          },
          {
            commandId: "selectAll",
            label: (0, r.WZ)("Select All"),
            category: (0, r.WZ)("General"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "workbench.toggleFindAndReplace",
            label: (0, r.WZ)("Find & Replace"),
            category: (0, r.WZ)("General"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.addSubTopic",
            label: (0, r.WZ)("Subtopic"),
            category: (0, r.WZ)("Insert Topics & Elements"),
            fixed: !0,
          },
          {
            commandId: "editor.addTopic",
            label: (0, r.WZ)("Topic After"),
            category: (0, r.WZ)("Insert Topics & Elements"),
          },
          {
            commandId: "editor.addTopicBefore",
            label: (0, r.WZ)("Topic Before"),
            category: (0, r.WZ)("Insert Topics & Elements"),
          },
          {
            commandId: "editor.addParentTopic",
            label: (0, r.WZ)("Parent Topic"),
            category: (0, r.WZ)("Insert Topics & Elements"),
          },
          {
            commandId: "editor.addCallout",
            label: (0, r.WZ)("Callout"),
            category: (0, r.WZ)("Insert Topics & Elements"),
          },
          {
            commandId: "editor.addRelationship",
            label: (0, r.WZ)("Relationship"),
            category: (0, r.WZ)("Insert Topics & Elements"),
          },
          {
            commandId: "editor.addBoundary",
            label: (0, r.WZ)("Boundary"),
            category: (0, r.WZ)("Insert Topics & Elements"),
          },
          {
            commandId: "editor.addSummary",
            label: (0, r.WZ)("Summary"),
            category: (0, r.WZ)("Insert Topics & Elements"),
          },
          {
          ...
          },
          {
            ...
            label: (0, r.WZ)("Attachment"),
            category: (0, r.WZ)("Insert Topics & Elements"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.addAudioOnNewTopic",
            label: (0, r.WZ)("Audio Note"),
            category: (0, r.WZ)("Insert Topics & Elements"),
            isSupportedInOutliner: !0,
          },
          {
          ...
          },
          {
            ...
            label: (0, r.WZ)('Set Numbering as "I.II.III."'),
            category: (0, r.WZ)("Numbering"),
          },
          {
            commandId: "editor.toggleNumberingTieredEnabled",
            label: (0, r.WZ)("Set Numbering Tiered Numbers"),
            category: (0, r.WZ)("Numbering"),
          },
          {
            commandId: "editor.toggleNumberingStartsHereEnabled",
            label: (0, r.WZ)("Set Numbering Start From Begin"),
            category: (0, r.WZ)("Numbering"),
          },
          {
            commandId: "editor.focusAndSelectCenter",
            label: (0, r.WZ)("Go to Central Topic"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "editor.moveSelection",
            label: (0, r.WZ)("Move Selection"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "editor.selectMultipleTopics",
            label: (0, r.WZ)("Select Multiple Topics"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "editor.exchangeSiblingTopicUp",
            label: (0, r.WZ)("Move Topic Up"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "editor.exchangeSiblingTopicDown",
            label: (0, r.WZ)("Move Topic Down"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "editor.moveTopicToTop",
            label: (0, r.WZ)("Move Topic to Top"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "editor.moveTopicToBottom",
            label: (0, r.WZ)("Move Topic to Bottom"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "selectAllDescendantTopics",
            label: (0, r.WZ)("Select All Subtopics"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "selectAllSiblingTopics",
            label: (0, r.WZ)("Select All Siblings"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "selectAllSameLevelTopics",
            label: (0, r.WZ)("Select All Same Level Topics"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "selectAllFloatingTopics",
            label: (0, r.WZ)("Select All Floating Topics"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "selectAllRelationships",
            label: (0, r.WZ)("Select All Relationships"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "selectAllSummaryTopics",
            label: (0, r.WZ)("Select All Summaries"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "selectAllBoundaries",
            label: (0, r.WZ)("Select All Boundaries"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "selectAllImages",
            label: (0, r.WZ)("Select All Images"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "selectAllEquations",
            label: (0, r.WZ)("Select All Equations"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "selectAllCalloutTopics",
            label: (0, r.WZ)("Select All Callouts"),
            category: (0, r.WZ)("Select & Move"),
          },
          {
            commandId: "outliner.addTopic",
            label: (0, r.WZ)("Create Topic"),
            category: (0, r.WZ)("Select/Manipulate Topics (Outliner)"),
            groupName: "outliner",
          },
          {
            commandId: "outliner.deleteTopic",
            label: (0, r.WZ)("Quick-Delete Topic"),
            category: (0, r.WZ)("Select/Manipulate Topics (Outliner)"),
            groupName: "outliner",
          },
          {
          ...
          },
          {
            ...
            label: (0, r.WZ)("Outdent"),
            category: (0, r.WZ)("Select/Manipulate Topics (Outliner)"),
            groupName: "outliner",
          },
          {
            commandId: "outliner.multiSelectionNavigateUp",
            label: (0, r.WZ)("Multi-Select Topics Above"),
            category: (0, r.WZ)("Select/Manipulate Topics (Outliner)"),
            groupName: "outliner",
          },
          {
            commandId: "outliner.multiSelectionNavigateDown",
            label: (0, r.WZ)("Multi-Select Topics Below"),
            category: (0, r.WZ)("Select/Manipulate Topics (Outliner)"),
            groupName: "outliner",
          },
          {
          ...
          },
          {
            commandId: "editor.enterLineBreak",
            label: (0, r.WZ)("Enter Line Break"),
            category: (0, r.WZ)("Edit Text (Outliner)"),
            groupName: "outliner",
          },
          {
            commandId: "outliner.moveCaretCharacterToBeginning",
            label: (0, r.WZ)("Move to Beginning of Current Topic"),
            category: (0, r.WZ)("Edit Text (Outliner)"),
            groupName: "outliner",
          },
          {
            commandId: "outliner.moveCaretCharacterToEnd",
            label: (0, r.WZ)("Move to End of Current Topic"),
            category: (0, r.WZ)("Edit Text (Outliner)"),
            groupName: "outliner",
          },
          {
            commandId: "outliner.moveCaretCharacterToAboveSiblingTopic",
            label: (0, r.WZ)("Move to Previous Topic of Same Level"),
            category: (0, r.WZ)("Edit Text (Outliner)"),
            groupName: "outliner",
          },
          {
            commandId: "outliner.moveCaretCharacterToBelowSiblingTopic",
            label: (0, r.WZ)("Move to Next Topic of Same Level"),
            category: (0, r.WZ)("Edit Text (Outliner)"),
            groupName: "outliner",
          },
          {
            commandId: "workbench.switchToMapOrOutliner",
            label: (0, r.WZ)("Switch to Map/Outliner"),
            category: (0, r.WZ)("Adjust Map & View"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.toggleBranch",
            label: (0, r.WZ)("Fold/Unfold Subtopics"),
            category: (0, r.WZ)("Adjust Map & View"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.toggleBranchByNumber",
            label: (0, r.WZ)("Fold/Unfold Subtopics (Level 1~9)"),
            category: (0, r.WZ)("Adjust Map & View"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.toggleAllBranch",
            label: (0, r.WZ)("Fold/Unfold Sub-Branches"),
            category: (0, r.WZ)("Adjust Map & View"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.toggleBranchOnly",
            label: (0, r.WZ)("Show Branch Only"),
            category: (0, r.WZ)("Adjust Map & View"),
            isSupportedInOutliner: !0,
          },
          null,
          {
            ...
            label: (0, r.WZ)("Zoom In"),
            category: (0, r.WZ)("Adjust Map & View"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.zoomOut",
            label: (0, r.WZ)("Zoom Out"),
            category: (0, r.WZ)("Adjust Map & View"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.resetZoom",
            label: (0, r.WZ)("Actual Size"),
            category: (0, r.WZ)("Adjust Map & View"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.fitMap",
            label: (0, r.WZ)("Fit Map"),
            category: (0, r.WZ)("Adjust Map & View"),
          },
          {
            commandId: "frame.toggleTabbar",
            label: (0, r.WZ)("Show Tab Bar"),
            category: (0, r.WZ)("Adjust Map & View"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "workbench.toggleTopicNavigationPanel",
            label: (0, r.WZ)("Show Navigation Panel - Topic"),
            category: (0, r.WZ)("Adjust Map & View"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "workbench.toggleNoteNavigationPanel",
            label: (0, r.WZ)("Show Navigation Panel - Note"),
            category: (0, r.WZ)("Adjust Map & View"),
          },
          {
            commandId: "workbench.toggleLabelAndMarkerNavigationPanel",
            label: (0, r.WZ)("Show Navigation Panel - Marker & Label"),
            category: (0, r.WZ)("Adjust Map & View"),
          },
          {
            commandId: "workbench.toggleTopicPanel",
            label: (0, r.WZ)("Show Format Panel - Style"),
            category: (0, r.WZ)("Adjust Map & View"),
          },
          {
            commandId: "workbench.toggleSlidePanel",
            label: (0, r.WZ)("Show Format Panel - Pitch"),
            category: (0, r.WZ)("Adjust Map & View"),
          },
          {
            commandId: "workbench.toggleMapPanel",
            label: (0, r.WZ)("Show Format Panel - Map"),
            category: (0, r.WZ)("Adjust Map & View"),
          },
          {
            commandId: "workbench.toggleSkeletonPanel",
            label: (0, r.WZ)("Show Format Panel - Skeleton"),
            category: (0, r.WZ)("Adjust Map & View"),
          },
          {
            commandId: "workbench.toggleColorThemePanel",
            label: (0, r.WZ)("Show Format Panel - Color Theme"),
            category: (0, r.WZ)("Adjust Map & View"),
          },
          {
            commandId: "editor.toggleTopicCountLabel",
            label: (0, r.WZ)("Show Topic Count"),
            category: (0, r.WZ)("Adjust Map & View"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.toggleSheetBar",
            label: (0, r.WZ)("Show Sheet Bar"),
            category: (0, r.WZ)("Adjust Map & View"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "editor.toggleShowGuideline",
            label: (0, r.WZ)("Display/Hide Smart Guideline"),
            category: (0, r.WZ)("Adjust Map & View"),
          },
          {
            commandId: "workbench.exportPng1",
            label: (0, r.WZ)("Export to PNG"),
            category: (0, r.WZ)("Export"),
          },
          {
            commandId: "workbench.exportJpeg",
            label: (0, r.WZ)("Export to JPEG"),
            category: (0, r.WZ)("Export"),
          },
          {
            commandId: "workbench.exportSvg1",
            label: (0, r.WZ)("Export to SVG"),
            category: (0, r.WZ)("Export"),
          },
          {
            commandId: "workbench.exportPdf",
            label: (0, r.WZ)("Export to PDF"),
            category: (0, r.WZ)("Export"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "workbench.exportMd",
            label: (0, r.WZ)("Export to Markdown"),
            category: (0, r.WZ)("Export"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "workbench.exportWord",
            label: (0, r.WZ)("Export to Word"),
            category: (0, r.WZ)("Export"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "workbench.exportExcel",
            label: (0, r.WZ)("Export to Excel"),
            category: (0, r.WZ)("Export"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "workbench.exportOPML",
            label: (0, r.WZ)("Export to OPML"),
            category: (0, r.WZ)("Export"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "workbench.exportTextBundle",
            label: (0, r.WZ)("Export to TextBundle"),
            category: (0, r.WZ)("Export"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "mapShot",
            label: (0, r.WZ)("Map Shot"),
            category: (0, r.WZ)("Tools & Others"),
          },
          {
            commandId: "mergeXMindFiles",
            label: (0, r.WZ)("Merge Xmind Files"),
            category: (0, r.WZ)("Tools & Others"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "customizeTheme",
            label: (0, r.WZ)("Create/Customize Theme"),
            category: (0, r.WZ)("Tools & Others"),
          },
          {
            commandId: "createTheme",
            label: (0, r.WZ)("Create Theme"),
            category: (0, r.WZ)("Tools & Others"),
          },
          {
            commandId: "workbench.toggleZenMode",
            label: (0, r.WZ)("ZEN Mode"),
            category: (0, r.WZ)("Tools & Others"),
          },
          {
            commandId: "editor.enterPitchMode",
            label: (0, r.WZ)("Pitch Mode"),
            category: (0, r.WZ)("Tools & Others"),
          },
          {
            commandId: "editor.enterPitchModeWindowed",
            label: (0, r.WZ)("Pitch Mode - In Window"),
            category: (0, r.WZ)("Tools & Others"),
          },
          {
            commandId: "editor.enterPitchPresenterViewMode",
            label: (0, r.WZ)("Pitch Mode - Presenter View"),
            category: (0, r.WZ)("Tools & Others"),
          },
          {
            commandId: "keyAssist",
            label: (0, r.WZ)("Key Assist"),
            category: (0, r.WZ)("Tools & Others"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "workbench.setpassword",
            label: (0, r.WZ)("Set File Password "),
            category: (0, r.WZ)("Tools & Others"),
            isSupportedInOutliner: !0,
          },
          {
            commandId: "preferences",
            label: (0, r.WZ)("Preferences"),
            category: (0, r.WZ)("Tools & Others"),
            isSupportedInOutliner: !0,
          },
        ].filter(Boolean),
        a = [
          {
            ...
            label: (0, r.WZ)("Next Step"),
            category: (0, r.WZ)("Navigation"),
            accelerator: ["Space", "||", "→", "||", "↓"],
          },
          {
            commandId: "pitch.previousStep",
            label: (0, r.WZ)("Previous Step"),
            category: (0, r.WZ)("Navigation"),
            accelerator: ["←", "||", "↑"],
          },
          {
            commandId: "pitch.skipCurrentBranch",
            label: (0, r.WZ)("Skip Current Branch"),
            category: (0, r.WZ)("Navigation"),
            accelerator: ["Shift", "+", "→"],
          },
          {
            commandId: "pitch.backParentTopic",
            label: (0, r.WZ)("Back to Parent Topic"),
            category: (0, r.WZ)("Navigation"),
            accelerator: ["Shift", "+", "←"],
          },
          {
            commandId: "pitch.exit",
            label: (0, r.WZ)("Exit Pitch Mode"),
            category: (0, r.WZ)("Other"),
            accelerator: ["Esc", "||", "Q"],
          },
          {
            commandId: "pitch.toggleAnimation",
            label: (0, r.WZ)("Enable/disable Animation"),
            category: (0, r.WZ)("Other"),
            accelerator: ["A"],
          },
          {
            commandId: "pitch.showShortcuts",
            label: (0, r.WZ)("Show Keyboard Shortcuts"),
            category: (0, r.WZ)("Other"),
            accelerator: ["?"],
          },
        ],
    ...
    20993: (e, t, n) => {
      ...
      var r = n(18621);
      const o = (e) => (0, r.L9)({ eventName: "Gallery", eventAction: e }),
        a = () =>
          (0, r.L9)({ eventAction: "insertTask", eventName: "insertTask" }),
        i = (e) => (0, r.L9)({ eventAction: "editTask", eventName: e }),
        s = () =>
          (0, r.L9)({ eventAction: "cancelTask", eventName: "cancelTask" }),
        l = (e) => (0, r.L9)({ eventAction: "highlightTask", eventName: e }),
        c = (e) =>
          (0, r.L9)({ eventAction: "insertIllustration", eventName: e }),
        u = (e) =>
          (0, r.L9)({ eventAction: "searchIllustration", eventName: e }),
        d = (e) =>
          (0, r.L9)({ eventAction: "insertIllustrationPro", eventName: e }),
        p = (e, t, n) =>
          (0, r.L9)({
            eventAction: "openTemplateType",
            eventName: `${e}_${t}_${n}`,
          }),
        m = (e) => (0, r.L9)({ eventAction: "popPW", eventName: e }),
        h = (e) => (0, r.L9)({ eventAction: "clickPW", eventName: e }),
        f = () => {
          (0, r.L9)({ eventAction: "cancelOverlap" });
        },
        v = () => (0, r.L9)({ eventAction: "paymentPage" }),
        g = () => (0, r.L9)({ eventAction: "paymentPageCN" }),
        b = () => (0, r.L9)({ eventAction: "paymentSuccessful" }),
        y = () => (0, r.L9)({ eventAction: "paymentSuccessfulCN" }),
        w = (e) => (0, r.L9)({ eventName: "PWD-sp35-240515", eventAction: e }),
        x = () => (0, r.L9)({ eventAction: "sharetoCollaboration" }),
        S = () => (0, r.L9)({ eventAction: "sharetoEvernote" }),
        k = (e) => (0, r.L9)({ eventAction: "pweDisplay", eventName: e }),
        _ = (e) => (0, r.L9)({ eventAction: "pweContinue", eventName: e }),
        I = (e) => (0, r.L9)({ eventAction: "closePwe", eventName: e }),
        Z = (e) => (0, r.L9)({ eventAction: "pweOrder", eventName: e }),
        T = (e) => (0, r.L9)({ eventAction: "purchaseSource", eventName: e }),
        A = (e) => (0, r.L9)({ eventAction: "purchaseWindow", eventName: e }),
        W = ({ region: e, productId: t }) =>
          (0, r.L9)({
            eventCategory: "Activate",
            eventAction: "clickSubscriptButton" + e.toLowerCase(),
            eventName: t,
          }),
        O = ({ region: e, productId: t }) =>
          (0, r.L9)({
            eventCategory: "Activate",
            eventAction: "clickSubscriptButtonMAS" + e.toLowerCase(),
            eventName: t,
          }),
        E = () => (0, r.L9)({ eventAction: "autoDisconnect" }),
        C = () =>
          (0, r.L9)({
    ...
    2563: (e, t, n) => {
      ...
      const a = (0, r.Q_)("renderer-app", () => {
        ...
        return {
          ...
          fontsForMindMap: r,
          updateFontsForMindMap: (e) => (r.value = e),
        };
      });
    },
    53775: (e, t, n) => {
      ...
      function a(e, t = 300, n = !1) {
        let r;
        function o(...t) {
          (r = void 0), n || e.apply(this, t);
        }
        const a = function (...a) {
          void 0 !== r && clearTimeout(r),
            n && !r && e.apply(this, a),
            (r = setTimeout(o.bind(this, ...a), t));
        };
        return (
          (a.cancel = function () {
      ...
      function i(e, t = 300, n = !1) {
        ...
        const l = function (...e) {
          if (i) return;
          if (((a = e), n && !o)) return void s.apply(this);
          const l = Date.now(),
            c = l - (null != o ? o : l);
          c >= t
            ? s.apply(this)
            : void 0 === r && (r = setTimeout(s.bind(this), t - c));
        };
        return (
          (l.cancel = function (e = !0) {
            void 0 !== r && (clearTimeout(r), (r = void 0)),
              (o = void 0),
              (i = e);
          }),
      ...
      const s = (0, o.aZ)({
        ...
        setup(e) {
          const t = e,
            ...
            l = (0, o.Fl)(() => s.value[t.type] || s.value[r.NO_RESULT]);
          return {
            __sfc: !0,
            NonePanelType: r,
            props: t,
    ...
    90029: (e, t, n) => {
      ...
      const o = (0, r.aZ)({
        ...
        setup(e, { emit: t }) {
          ...
          return (
            (0, r.bv)(async () => {
              if ((await new Promise((e) => setTimeout(e, 0)), !o.value))
                return;
              let e = 0,
                r = 0,
                i = null;
              (a = new IntersectionObserver(([n]) => {
                const o = n.isIntersecting,
                  a = n.boundingClientRect.top;
                o
                  ? ((e = n.boundingClientRect.top),
                    0 !== r && (i = a > r ? "top" : "bottom"))
                  : ((r = n.boundingClientRect.top),
                    0 !== e && (i = a > e ? "top" : "bottom")),
                  t("change", { visible: o, direction: i });
              }, n.options)),
                a.observe(o.value);
            }),
            (0, r.Jd)(() => {
            ...
            { __sfc: !0, props: n, emit: t, entryContainer: o, io: a }
          );
        },
      });
      const a = (0, n(51900).Z)(
        ...
        g = {
          ...
          methods: {
            isShowPlaceholder(e, t) {
              const n = this.acceleratorEdited[t];
              return (
                !(n && n.valid ? n.accelerator : e) &&
                this.commandIdBeFocus === t
              );
            },
            displaySymbols(e, t) {
              const n = this.acceleratorEdited[t],
                r = n && n.valid ? n.accelerator : e;
              if (!r)
                return this.commandIdBeFocus === t
                  ? this.$T("Enter a Shortcut")
                  : this.$T("None");
              let o = r.split("+").map((e) => this.modifierIcon[e] || e),
                a = { Control: !1, undefined: !1 };
              return o
                .filter((e) => void 0 === a[e])
                .join(" ")
                .replace("=", "+");
            ...
            focusKeyBinding(e, t) {
              e.target.focus();
              const n = this.acceleratorEdited[t.commandId],
                r = n && n.valid ? n.accelerator : t.accelerator;
              (this.commandIdBeClear = r ? t.commandId : ""),
            ...
            rectifyKeyBinding(e, t) {
              ...
              if (27 === n) return void this.exitListenKeyBinding(e, t);
              const s = t.commandId,
              ...
              u.forEach((e) => {
                if (p.includes(e))
                  ...
                  const t = (0, f.f7)().keybindingByCommandIdAndGroup(
                    ...
                    n = (0, f.f7)().keybindingByCommandIdAndGroup(
                      e,
                      "outliner"
                    );
                  d.push(t), d.push(n);
                ...
                (d = d.filter((e) => !!e));
              let m = (0, f.f7)().commandIdByKeybinding({
                keybinding: c,
                groupName: l,
              });
              !m &&
                u.includes(s) &&
                "outliner" !== l &&
                (m = (0, f.f7)().commandIdByKeybinding({
                  keybinding: c,
                  groupName: "outliner",
                })),
                (d.includes(c) || (m && !p.includes(m))) &&
            ...
            setAccelerator(e, t) {
              if (this.acceleratorEdited[e.commandId])
                r.ZP.set(this.acceleratorEdited[e.commandId], "accelerator", t);
              else {
                const n =
                ...
                r.ZP.set(this.acceleratorEdited, e.commandId, {
                  dirty: !0,
                  accelerator: t,
                  oldAccelerator: n,
            ...
            setValid(e, t) {
              this.acceleratorEdited[e.commandId] &&
                ...
                r.ZP.set(this.acceleratorEdited[e.commandId], "valid", !0));
            },
            async applyChanges() {
              const e = [],
                t = [];
              Object.keys(this.acceleratorEdited).forEach((n) => {
                const r = this.acceleratorEdited[n];
                (r.commandId = n),
                  r.oldAccelerator && e.push(r),
                  r.accelerator && t.push(r);
              }),
                e.forEach(async (e) => {
                  const { oldAccelerator: t, commandId: n, groupName: r } = e,
                    o = (0, f.f7)().keybindingsByCommandIdAndGroup(n, r);
                  o.length > 1 && o[0] === t
                    ? o.forEach(async (e) => {
                ...
                t.forEach(async (e) => {
                  const { accelerator: t, commandId: n, groupName: r } = e;
                  (0, f.f7)().binding({
                    commandId: n,
                    keybinding: t,
                    groupName: r,
            ...
            searchShortcutsByGroup() {
              ...
              for (const t in e) {
                const o = e[t],
                  a = {};
                for (const e in o) n.test(o[e].label) && (a[e] = o[e]);
                Object.keys(a).length && (r[t] = a);
              }
              this.searchedShortcutGroups = { ...r };
            },
            handleShowInputMenu: (e) => (0, p.Sr)(e),
          },
          computed: {
            allGroupOption() {
              return this.$T("All");
          ...
          watch: {
            inputedShortcutName: a()(function () {
              this.searchShortcutsByGroup();
            }, 200),
          },
          mounted() {
        ...
        function () {
          ...
          return t("div", { staticClass: "uk-height-expand" }, [
            t("div", { staticClass: "uk-flex uk-flex-row uk-margin" }, [
              t("div", [
                t(
                  ...
                  [
                    t("span", [e._v(e._s(e.$T("$$", e.selectedGroup)))]),
                    e._v(" "),
                    t("span", {
                      staticStyle: { "margin-left": "8px" },
                      attrs: {
                ...
                t(
                  ...
                  [
                    t(
                      ...
                      e._l(e.shortcutGroups, function (n, r) {
                        return t("li", { key: r }, [
                          t(
                            "button",
                            {
                              class: { "uk-active": e.selectedGroup === r },
                              attrs: { autofocus: e.selectedGroup === r },
                              on: {
                                click: function (t) {
                                  return e.onSelectedGroupChange(r);
                                },
                              },
                            },
                            [
              ...
              t(
                "div",
                { staticClass: "uk-margin-small-left uk-flex-1" },
                [
                  t("vk-input", {
                    attrs: {
                      prefix: "search",
                    ...
                    on: {
                      ...
                      contextmenu: e.handleShowInputMenu,
                    },
                  }),
                ],
                1
            ...
            t(
              ...
              [
                e._l(e.searchedShortcutGroups, function (n, r, o) {
                  return t(
                    "div",
                    { key: r, staticClass: "uk-form-aligned uk-margin" },
                    [
                      t("h2", [
                        e._v("\n        " + e._s(e.$T("$$", r)) + "\n      "),
                      ]),
                      ...
                      e._l(n, function (n, r) {
                        return t(
                          "div",
                          { key: r, staticClass: "uk-margin-small" },
                          [
                            t(
                              "label",
                              {
                              ...
                              t(
                                ...
                                [
                                  ...
                                  t(
                                    ...
                                    {
                                      staticClass:
                                        "vk-input-default vk-size-small uk-flex-center",
                                      class: {
                                        "uk-form-placeholder-color":
                                          e.isShowPlaceholder(n.accelerator, r),
                                      },
                                      attrs: { tabindex: "-1" },
                                      on: {
                                        click: function (t) {
                                          return e.focusKeyBinding(t, n);
                                        },
                                        keydown: function (t) {
                                          return e.listenKeyBinding(t, n);
                                        },
                                        keyup: function (t) {
                                          return e.rectifyKeyBinding(t, n);
                                        },
                                        blur: function (t) {
                                          return e.exitListenKeyBinding(t, n);
                                        },
                                      },
                                    },
                                    [
                                      e._v(
                                        e._s(e.displaySymbols(n.accelerator, r))
                                      ),
                                    ]
                                  ),
                                ]
                      ...
                      e._v(" "),
                      o + 1 < Object.keys(e.searchedShortcutGroups).length
                        ? t("hr")
                        : e._e(),
                    ],
                    2
    ...
    97234: (e, t, n) => {
            ...
            (N(e.r) && N(e.g) && N(e.b)
              ...
              : N(e.h) &&
                ...
                (t = (function (e, t, n) {
                  ...
                  if (
                    ((e = Z(e, 360)), (t = Z(t, 100)), (n = Z(n, 100)), 0 === t)
                  )
                    r = o = a = n;
                  else {
      ...
      function d(e, t) {
        t = 0 === t ? 0 : t || 10;
        var n = i(e).toHsl();
        return (n.s -= t / 100), (n.s = T(n.s)), i(n);
      }
      function p(e, t) {
        t = 0 === t ? 0 : t || 10;
        var n = i(e).toHsl();
      ...
      function h(e, t) {
        t = 0 === t ? 0 : t || 10;
        var n = i(e).toHsl();
        return (n.l += t / 100), (n.l = T(n.l)), i(n);
      }
      function f(e, t) {
        t = 0 === t ? 0 : t || 10;
        var n = i(e).toRgb();
      ...
      function y(e, t) {
        ...
        for (var n = i(e).toHsl(), r = [i(e)], o = 360 / t, a = 1; a < t; a++)
          r.push(i({ h: (n.h + a * o) % 360, s: n.s, l: n.l }));
        return r;
      }
      function w(e) {
        var t = i(e).toHsl(),
      ...
      function S(e, t) {
        t = t || 6;
        for (
          var n = i(e).toHsv(), r = n.h, o = n.s, a = n.v, s = [], l = 1 / t;
          t--;

        )
          s.push(i({ h: r, s: o, v: a })), (a = (a + l) % 1);
        return s;
      }
      (i.prototype = {
        isDark: function () {
        ...
        toPercentageRgb: function () {
          return {
            r: Math.round(100 * Z(this._r, 255)) + "%",
            g: Math.round(100 * Z(this._g, 255)) + "%",
            b: Math.round(100 * Z(this._b, 255)) + "%",
            a: this._a,
          };
        },
        toPercentageRgbString: function () {
          return 1 == this._a
            ? "rgb(" +
                Math.round(100 * Z(this._r, 255)) +
                "%, " +
                Math.round(100 * Z(this._g, 255)) +
                "%, " +
                Math.round(100 * Z(this._b, 255)) +
                "%)"
            : "rgba(" +
                Math.round(100 * Z(this._r, 255)) +
                "%, " +
        ...
        toName: function () {
          return 0 === this._a
            ? "transparent"
            : !(this._a < 1) && (_[c(this._r, this._g, this._b, !0)] || !1);
        },
        toFilter: function (e) {
        ...
        (i.fromRatio = function (e, t) {
          if ("object" == r(e)) {
            var n = {};
            for (var o in e)
              e.hasOwnProperty(o) && (n[o] = "a" === o ? e[o] : O(e[o]));
            e = n;
          }
          return i(e, t);
        }),
        ...
        (i.mostReadable = function (e, t, n) {
          ...
          for (var u = 0; u < t.length; u++)
            (r = i.readability(e, t[u])) > c && ((c = r), (l = i(t[u])));
          return i.isReadable(e, l, { level: a, size: s }) || !o
            ? l
